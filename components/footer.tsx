      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="flex flex-col items-start">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <div className="text-sm font-bold text-gray-900">TESDA Region VII</div>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="#home" className="text-sm text-gray-600 hover:text-blue-600 transition-colors duration-200">
                  Home
                </Link>
              </li>
              <li>
        ...
        <div className="pt-8 border-t border-gray-200">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-600">© {new Date().getFullYear()} TESDA Region VII. All rights reserved.</p>
            <p className="text-sm text-gray-600">
