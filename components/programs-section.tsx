    ...
    <section id="programs" className="py-20 bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center mb-16">
          <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-6">Programs & Services</h2>
          <div className="w-20 h-1 bg-blue-600 mx-auto mb-6" />
          <p className="text-lg text-gray-700 text-pretty">
            Discover our comprehensive range of programs designed to equip you with industry-relevant skills and
            certifications.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
          {programs.map((program, index) => (
            <Card
              key={index}
              className="p-8 border-2 border-blue-200 hover:border-blue-600 transition-all duration-300 hover:shadow-xl bg-white group"
            >
